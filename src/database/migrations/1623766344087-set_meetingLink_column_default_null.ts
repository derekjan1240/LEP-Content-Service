...
export class setMeetingLinkColumnDefaultNull1623766344087 implements MigrationInterface {
    name = 'setMeetingLinkColumnDefaultNull1623766344087'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `classroom` CHANGE `meetingLink` `meetingLink` varchar(255) NULL DEFAULT ''''");
