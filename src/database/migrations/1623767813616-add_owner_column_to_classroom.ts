...
export class addOwnerColumnToClassroom1623767813616 implements MigrationInterface {
    name = 'addOwnerColumnToClassroom1623767813616'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `classroom` ADD `owner` varchar(255) NOT NULL");
        ...
        await queryRunner.query("ALTER TABLE `student_group` DROP FOREIGN KEY `FK_7d2f1b407978d6f1fb912f684e1`");
        await queryRunner.query("ALTER TABLE `student_group` CHANGE `createDateTime` `createDateTime` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP");
        await queryRunner.query("ALTER TABLE `student_group` CHANGE `lastChangedDateTime` `lastChangedDateTime` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(6)");
        await queryRunner.query("ALTER TABLE `student_group` CHANGE `internalComment` `internalComment` varchar(300) NULL");
        await queryRunner.query("ALTER TABLE `student_group` CHANGE `classroomId` `classroomId` varchar(36) NULL");
        await queryRunner.query("ALTER TABLE `classroom` CHANGE `createDateTime` `createDateTime` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP");
        await queryRunner.query("ALTER TABLE `classroom` CHANGE `lastChangedDateTime` `lastChangedDateTime` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(6)");
        await queryRunner.query("ALTER TABLE `classroom` CHANGE `internalComment` `internalComment` varchar(300) NULL");
        await queryRunner.query("ALTER TABLE `classroom` CHANGE `description` `description` varchar(500) NULL");
        await queryRunner.query("ALTER TABLE `classroom` CHANGE `meetingLink` `meetingLink` varchar(255) NULL");
        await queryRunner.query("ALTER TABLE `classroom` CHANGE `studentList` `studentList` varchar(255) NULL");
        ...
        await queryRunner.query("ALTER TABLE `student_group` ADD CONSTRAINT `FK_7d2f1b407978d6f1fb912f684e1` FOREIGN KEY (`classroomId`) REFERENCES `classroom`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `lecture` DROP FOREIGN KEY `FK_434a7daa0735275a30cb5fec85b`");
        await queryRunner.query("ALTER TABLE `grade` DROP FOREIGN KEY `FK_c85f5d8e8daf2966d3f8e982777`");
        await queryRunner.query("ALTER TABLE `classroom` CHANGE `studentList` `studentList` varchar(255) NULL DEFAULT 'NULL'");
        await queryRunner.query("ALTER TABLE `classroom` CHANGE `meetingLink` `meetingLink` varchar(255) NULL DEFAULT 'NULL'");
        await queryRunner.query("ALTER TABLE `classroom` CHANGE `description` `description` varchar(500) NULL DEFAULT 'NULL'");
        await queryRunner.query("ALTER TABLE `classroom` CHANGE `internalComment` `internalComment` varchar(300) NULL DEFAULT 'NULL'");
        await queryRunner.query("ALTER TABLE `classroom` CHANGE `lastChangedDateTime` `lastChangedDateTime` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)");
        await queryRunner.query("ALTER TABLE `classroom` CHANGE `createDateTime` `createDateTime` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)");
        await queryRunner.query("ALTER TABLE `student_group` CHANGE `classroomId` `classroomId` varchar(36) NULL DEFAULT 'NULL'");
        await queryRunner.query("ALTER TABLE `student_group` CHANGE `internalComment` `internalComment` varchar(300) NULL DEFAULT 'NULL'");
        await queryRunner.query("ALTER TABLE `student_group` CHANGE `lastChangedDateTime` `lastChangedDateTime` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6)");
        await queryRunner.query("ALTER TABLE `student_group` CHANGE `createDateTime` `createDateTime` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)");
        await queryRunner.query("ALTER TABLE `student_group` ADD CONSTRAINT `FK_7d2f1b407978d6f1fb912f684e1` FOREIGN KEY (`classroomId`) REFERENCES `classroom`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION");
        ...
        await queryRunner.query("ALTER TABLE `classroom` DROP COLUMN `owner`");
    }
