...
export class lectureAddOrderColumn1621344701856 implements MigrationInterface {
    name = 'lectureAddOrderColumn1621344701856'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `lecture` ADD `order` int UNSIGNED NOT NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `lecture` DROP COLUMN `order`");
    }
