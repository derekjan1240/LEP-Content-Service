...
export class addMeetingLinkColumnToClassroom1623766242414 implements MigrationInterface {
    name = 'addMeetingLinkColumnToClassroom1623766242414'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `classroom` ADD `meetingLink` varchar(255) NULL DEFAULT ''");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `classroom` DROP COLUMN `meetingLink`");
    }
