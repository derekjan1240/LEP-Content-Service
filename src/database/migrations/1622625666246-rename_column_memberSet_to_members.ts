...
export class renameColumnMemberSetToMembers1622625666246 implements MigrationInterface {
    name = 'renameColumnMemberSetToMembers1622625666246'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `student_group` CHANGE `memberSet` `members` varchar(255) NOT NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `student_group` CHANGE `members` `memberSet` varchar(255) NOT NULL");
    }
