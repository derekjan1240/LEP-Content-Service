...
export class renameColumnUserToOwner1622435842249 implements MigrationInterface {
    name = 'renameColumnUserToOwner1622435842249'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `exercise` CHANGE `user` `owner` varchar(255) NOT NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `exercise` CHANGE `owner` `user` varchar(255) NOT NULL");
    }
