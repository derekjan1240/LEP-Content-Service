...
export class subjectAndGradeAddOrder1620275874889 implements MigrationInterface {
    name = 'subjectAndGradeAddOrder1620275874889'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `subject` ADD `order` int UNSIGNED NOT NULL");
        await queryRunner.query("ALTER TABLE `grade` ADD `order` int UNSIGNED NOT NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `grade` DROP COLUMN `order`");
        await queryRunner.query("ALTER TABLE `subject` DROP COLUMN `order`");
    }
