...
export class questionTitleMaxLength50To5001622446821749 implements MigrationInterface {
    name = 'questionTitleMaxLength50To5001622446821749'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `question` ADD `title` varchar(500) NOT NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `question` DROP COLUMN `title`");
        await queryRunner.query("ALTER TABLE `question` ADD `title` varchar(50) NOT NULL");
