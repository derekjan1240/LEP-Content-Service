...
export class addUserColumnToExerciseTable1622435486915 implements MigrationInterface {
    name = 'addUserColumnToExerciseTable1622435486915'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query("ALTER TABLE `exercise` ADD `user` varchar(255) NOT NULL");
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("ALTER TABLE `exercise` DROP COLUMN `user`");
    }
